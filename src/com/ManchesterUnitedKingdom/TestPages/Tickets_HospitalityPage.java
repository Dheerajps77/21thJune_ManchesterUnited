...
public class Tickets_HospitalityPage 
{
	...
	@FindBy(how=How.XPATH, using="//li[contains(@class,' no-child  nav-item')]//a[text()='Match Tickets']")
	...
	@FindBy(how=How.XPATH, using="//a//strong[text()='Club America']")
	WebElement ClubAmerica_Link;
